...
void buildTree(Rsm::Mesh* mesh)
{
	if (ImGui::TreeNode(mesh->name.c_str()))
	{
		ImGui::InputFloat3("Scale", glm::value_ptr(mesh->scale));
		ImGui::InputFloat("Rot", &mesh->rotangle);
		ImGui::InputFloat3("RotAxis", glm::value_ptr(mesh->rotaxis));
		ImGui::InputFloat3("Pos", glm::value_ptr(mesh->pos));
		ImGui::InputFloat3("Pos_", glm::value_ptr(mesh->pos_));
