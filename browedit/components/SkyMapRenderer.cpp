...
SkyMapRenderer::LubRenderContext::LubRenderContext() : shader(util::ResourceManager<gl::Shader>::load<LubShader>())
{
	shader->use();
...
void SkyMapRenderer::LubRenderContext::preFrame(Node* rootNode, NodeRenderContext& context)
{
	glEnable(GL_DEPTH_TEST);
	shader->use();
