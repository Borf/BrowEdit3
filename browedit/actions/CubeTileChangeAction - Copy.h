...
CubeTileChangeAction::CubeTileChangeAction(const std::map<Gnd::Cube*, float[3]>& oldValues, const std::map<Gnd::Cube*, float[3]>& newValues)
{
...
void CubeTileChangeAction::setNewHeights(Gnd* gnd, const std::vector<glm::ivec2>& endSelection)
{
