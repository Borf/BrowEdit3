...
namespace util
{
	...
	bool DragInt(BrowEdit* browEdit, Node* node, const char* label, int* ptr, float v_speed = 1, int v_min = 0.0f, int v_max = 0.0f, const std::string& action = "");
	bool DragFloat(BrowEdit* browEdit, Node* node, const char* label, float* ptr, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const std::string& action = "");
	...
	bool InputText(BrowEdit* browEdit, Node* node, const char* label, std::string* ptr, ImGuiInputTextFlags flags = 0, const std::string& action = "");
}