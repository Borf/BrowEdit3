 ...
 *
 * Commandline:
 *    --api='glx=1.4' --extensions='GLX_AMD_gpu_association' c --alias --loader
 *
 * Online:
 *    http://glad.sh/#api=glx%3D1.4&extensions=GLX_AMD_gpu_association&generator=c&options=ALIAS%2CLOADER
 *
 */
